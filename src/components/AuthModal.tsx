...
const AuthModal = ({ isOpen, onClose, onLogin }: AuthModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-white/95 backdrop-blur-sm border border-gray-200 rounded-2xl shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pr-10 py-3 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                  required
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 pt-4">
              ...
              <Button 
                ...
                variant="outline" 
                onClick={onClose} 
                className="w-full py-3 border-gray-200 rounded-lg hover:bg-gray-50"
              >
                إلغاء
              </Button>
            </div>
