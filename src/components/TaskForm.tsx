          ...
          <div>
            ...
            >
              ...
              <SelectContent className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                <SelectItem value="low" className="hover:bg-green-50 dark:hover:bg-green-900/30 text-gray-800 dark:text-gray-200">
                  🟢 منخفضة
                </SelectItem>
                <SelectItem value="medium" className="hover:bg-yellow-50 dark:hover:bg-yellow-900/30 text-gray-800 dark:text-gray-200">
                  🟡 متوسطة
                </SelectItem>
                <SelectItem value="high" className="hover:bg-red-50 dark:hover:bg-red-900/30 text-gray-800 dark:text-gray-200">
                  🔴 عالية
                </SelectItem>
              </SelectContent>
            </Select>
